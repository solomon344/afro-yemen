...
const CoreValues = () => {
  return (
    <div className='flex justify-center core bg-black text-gray-300 p-10'>
        ...
        <h1 className="text-4xl font-bold uppercase ">What defines us</h1>

        <div className='grid grid-cols-3 gap-3 p-6 pl-0'>
        ...
        <div className="flex items-center justify-center gap-3">
         ...
         <p className="line-clamp-2 text-sm text-gray-400">
          The well being of our beneficiaries is our priority, we invest every single dime we get from donations.
         </p>
         </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-3">
         ...
         <p className="line-clamp-2 text-sm text-gray-400">
          We believe in giving back to the community. We have no exception to whome benefits from us.
         </p>
         </div>
        </div>
